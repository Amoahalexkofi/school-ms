...
export function AddBookForm() {
  ...
  return (
    <main className="flex-1 p-6 max-w-4xl mx-auto w-full">
      <Link href="/library" className="inline-flex items-center gap-1 text-sm text-slate-500 hover:text-slate-700 mb-6">
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 min-h-[80px]"
