...
export default async function LeavePage() {
  const [leaveTypes, staffRequests, studentRequests, staff, students] = await Promise.all([
  ...
  return (
    <div className="flex flex-col flex-1">
      ...
      <LeaveClient leaveTypes={leaveTypes} staffRequests={staffRequests} studentRequests={studentRequests} staff={staff} students={students} />
    </div>
  );
}
