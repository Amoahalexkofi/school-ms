  ...
  return (
    <main className="min-h-screen bg-gray-100 p-6">
      ...
      <div className="print:hidden flex items-center justify-between mb-6 max-w-md mx-auto">
        <Link href={`/students/${student.id}`} className="flex items-center gap-1 text-sm text-slate-500 hover:text-slate-700">
      ...
      >
        ...
        <div className="flex gap-4 px-5 py-4 bg-slate-50">
          ...
          <div className="flex-shrink-0 w-20 h-24 rounded-lg bg-gray-100 border border-gray-200 flex items-center justify-center text-gray-300">
            {student.image
              ? <img src={student.image} alt="" className="w-full h-full object-cover rounded-lg" />
              : (
