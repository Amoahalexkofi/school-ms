      ...
      <div className="max-w-xl space-y-5">
        <Card>
          <CardContent className="pt-5 space-y-5">
            <h2 className="text-sm font-semibold text-gray-800">Assign Fee Group to a Class</h2>
            ...
            <div className="space-y-4">
              <div>
                ...
                {selectedSg && (
                  <p className="text-xs text-green-600 mt-1">Total: ₵{totalAmt.toLocaleString()} per student</p>
                )}
              </div>
