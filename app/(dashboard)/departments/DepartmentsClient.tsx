  ...
  return (
    <main className="flex-1 p-6 space-y-5 max-w-2xl">
      <div className="flex justify-between items-center">
        <p className="text-sm text-white/40">{departments.length} department{departments.length !== 1 ? "s" : ""}</p>
      ...
      {showAddPanel && (
        <div className="border border-blue-500/20 rounded-lg bg-blue-500/10 p-4">
          <div className="flex items-center justify-between mb-3">
            <h3 className="font-medium text-sm text-blue-300">Add Department</h3>
