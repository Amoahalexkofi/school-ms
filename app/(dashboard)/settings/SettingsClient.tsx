          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {[
                ...
                { href: "/settings/grading",         icon: GraduationCap, bg: "bg-indigo-100", ic: "text-indigo-600", label: "Grading & Divisions",   desc: "Grade scale & result divisions" },
                ...
                { href: "/settings/whatsapp",        icon: MessageSquare, bg: "bg-green-100",  ic: "text-green-600",  label: "WhatsApp Config",       desc: "Twilio / WATI / Meta Cloud API" },
                { href: "/settings/payment-gateway", icon: CreditCard,    bg: "bg-emerald-100", ic: "text-emerald-600", label: "Payment Gateway",       desc: "Paystack / Flutterwave online fees" },
