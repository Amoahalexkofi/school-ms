...
export async function POST(req: NextRequest) {
  try {
    ...
    const v = await (prisma as any).visitor.create({ data: { name: body.name.trim(), phone: body.phone || null, email: body.email || null, purposeId: body.purposeId || null, host: body.host || null, idProof: body.idProof || null, numVisitors: parseInt(body.numVisitors) || 1, note: body.note || null } });
